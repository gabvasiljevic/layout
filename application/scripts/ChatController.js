angular.module("istim").controller("ChatController", ['$scope', '$http', function(scope, http){
    $('#box1').hide();
   
    var username = '';
    var ChatAtual = '';
    
    if(scope.session.sessionUser != null){
        scope.loged = false;  // Controla se o usuario está logado ou não
        scope.ChatAtual = ''; // Com quem eu estou conversando agora
        username = scope.session.sessionUser.name;
